...
// FIXME: despawning actors crashes the game, so with this effect active, reloads will crash...
// thus, this effect remains disabled until a fix is found...
// Crash seems to be caused by the call to ZActor::Disable by the engine, but idk how to fix this...
